...
mod position_tracker_tests {
    use pmbots_arb::position_tracker::*;
...
mod circuit_breaker_tests {
    use pmbots_arb::circuit_breaker::*;
...
mod infra_integration_tests {
    use pmbots_arb::fees::{MatchSource, PolyCategory};
    use pmbots_arb::types::*;
...
mod execution_tests {
    ...
    fn test_nano_clock_monotonic() {
        use pmbots_arb::execution::NanoClock;
...
mod process_mock_tests {
    ...
    async fn test_process_kalshi_only_arb() {
        ...
        // Total fees = 2 + 2 = 4¢
        let expected_fees = pmbots_arb::types::kalshi_fee_cents(44)
            + pmbots_arb::types::kalshi_fee_cents(44);
        assert_eq!(
            req.estimated_fee_cents(),
            expected_fees,
    ...
    fn test_kalshi_only_double_fees() {
        use pmbots_arb::types::kalshi_fee_cents;
