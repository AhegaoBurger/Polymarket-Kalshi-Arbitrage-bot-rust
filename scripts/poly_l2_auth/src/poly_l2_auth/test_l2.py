"""Test L2 creds via py-clob-client-v2.

If get_balance_allowance returns a balance, the creds are valid and any
auth failure in the Rust bot is on the HMAC-signing side. If this also
returns 401, the creds themselves are wrong.
"""
